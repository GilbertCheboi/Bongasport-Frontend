...
export default function FootballDetail1(props) {
  ...
  const loadComment = () => { 
    fetch(`https://gilscore.azurewebsites.net/api/Europa/tweetcomments1/${id}/`, {
      method: 'GET',
      headers:{
  ...
  useEffect(() => {
    ...
    const createLoad =() => {
      ...
      //data.append('image', image);
        fetch('https://gilscore.azurewebsites.net/api/Europa/commentweet1/', {
        method: 'POST',
        headers: {
    ...
    const clickedItem = (data) => { 
      props.navigation.navigate('Detail2 Football',{data:data}) }
