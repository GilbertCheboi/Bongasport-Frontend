...
export default function Formula1Detail2(props) {
  ...
  const loadComment = () => { 
    fetch(`https://gilscore.azurewebsites.net/api/Formula1/tweetcomments2/${id}/`, {
      method: 'GET',
      headers:{
  ...
  useEffect(() => {
    ...
    const createLoad =() => {
      ...
      //data.append('image', image);
        fetch('https://gilscore.azurewebsites.net/api/Formula1/commentweet2/', {
        method: 'POST',
        headers: {
    ...
    //  }, [])  
     ...
     const clickedItem = (data) => { 
       props.navigation.navigate('Detail3 F1',{data:data}) }
