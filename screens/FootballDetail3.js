...
export default function FootballDetail3(props) {
  ...
  const loadComment = () => { 
    fetch(`https://gilscore.azurewebsites.net/api/Europa/tweetcomments3/${id}/`, {
      method: 'GET',
      headers:{
  ...
  useEffect(() => {
    ...
    const createLoad =() => {
      ...
      //data.append('image', image);
        fetch('https://gilscore.azurewebsites.net/api/Europa/commentweet3/', {
        method: 'POST',
        headers: {
    ...
    const clickedItem = (data) => { 
      props.navigation.navigate('Detail4 Football',{data:data}) }
