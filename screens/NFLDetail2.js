...
export default function NFLDetail2 (props) {
  ...
  const loadComment = () => { 
    fetch(`https://gilscore.azurewebsites.net/api/NFL/tweetcomments2/${id}/`, {
      method: 'GET',
      headers:{
  ...
  useEffect(() => {
    ...
    const createLoad =() => {
      ...
      //data.append('image', image);
        fetch('https://gilscore.azurewebsites.net/api/NFL/commentweet2/', {
        method: 'POST',
        headers: {
    ...
    const clickedItem = (data) => { 
      props.navigation.navigate('Detail3 NFL',{data:data}) }
