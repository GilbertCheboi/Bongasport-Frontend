...
export default function NBADetail2(props) {
  ...
  const loadComment = () => { 
    fetch(`https://gilscore.azurewebsites.net/api/NBA/tweetcomments2/${id}/`, {
      method: 'GET',
      headers:{
  ...
  useEffect(() => {
    ...
    const createLoad =() => {
      ...
      //data.append('image', image);
        fetch('https://gilscore.azurewebsites.net/api/NBA/commentweet2/', {
        method: 'POST',
        headers: {
    ...
    const clickedItem = (data) => { 
      props.navigation.navigate('Detail3 NBA',{data:data}) }
