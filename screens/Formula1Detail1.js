...
export default function Formula1Detail1(props) {
  ...
  const loadComment = () => { 
    fetch(`https://gilscore.azurewebsites.net/api/Formula1/tweetcomments1/${id}/`, {
      method: 'GET',
      headers:{
  ...
  useEffect(() => {
    ...
    const createLoad =() => {
      ...
      //data.append('image', image);
        fetch('https://gilscore.azurewebsites.net/api/Formula1/commentweet1/', {
        method: 'POST',
        headers: {
    ...
    //  }, [])  
     ...
     const clickedItem = (data) => { 
       props.navigation.navigate('Detail2 F1',{data:data}) }
